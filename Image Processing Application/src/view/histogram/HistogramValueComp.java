...
/**
 * Represents the histogram that shows the distribution of how much intensity there is.
 * This extends JPanel because each part of the histogram is comprised of JPanels stacked next to
 * each other.
 */
public class HistogramValueComp extends JPanel {
  ...
  /**
   * Creates a intensity histogram out of the passed in hash map of values corresponding to the max
   * height of the chart. The height corresponds to how much of intensity there is.
   *
   * @param values the map corresponding to the hue of intensity and how much intensity there
   *               is.
   */
  public HistogramValueComp(HashMap<Integer, Integer> values) {
